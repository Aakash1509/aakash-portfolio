  ...
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-center min-h-[70vh] bg-gray-50 px-4 py-12 md:py-20" id="hero">
      ...
      <div className="flex-1 text-center md:text-left w-full max-w-xl">
        ...
        <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-6">AWS Certified Java Developer | Cloud & Full Stack Enthusiast</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
          <a href="/Aakash%20Saraiya-Resume.pdf" className="inline-block bg-blue-600 text-white px-7 py-3 rounded-full font-semibold shadow hover:bg-blue-700 transition text-lg" download>Download Resume</a>
